...
% ###############################################################################################################################
%% Thesis Template
%% by Jörn Malzahn, Christoph Krimpmann, Christoph Rösmann, Maximilian Krämer
...
%& Settings
\input{settings/settings} % look in here for settings like languange, etc.
...
\iftoggle{thesis_phd}{%
\iftoggle{lang_eng}
	{\input{content/titlepage_phd_english}}
	{\input{content/titlepage_phd_german}}
}{%
\iftoggle{lang_eng}
	{\input{content/titlepage_btmt_english}}
	{\input{content/titlepage_btmt_german}}
}
\maketitle
...
%\iftoggle{lang_eng}
%{\input{content/chapter1_english}}
{\input{content/chapter1_intro.tex}}
% #######################################################
%\iftoggle{lang_eng}
%{\input{content/chapter2_english}}
%{\input{content/chapter2}}
% #######################################################
%\iftoggle{lang_eng}
%{\input{content/chapter3_english}}
%{\input{content/chapter3}}
% #########
\input{content/chapter2_theory.tex}
\input{content/chapter4Exp.tex}
\input{content/chapter3_method.tex}
%\input{content/chapter4Exp.tex}

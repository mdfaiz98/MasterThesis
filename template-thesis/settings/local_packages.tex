...
\usepackage[nonumberlist,acronym,toc,section,style=super,nopostdot,automake]{glossaries} % nomain, if you define glossaries in a file, and you use \include{INP-00-glossary}
%\newglossary[tlg]{grich}{tld}{tdn}{}
\newglossary*{greek}{}
\newglossary*{roman}{}
\newglossary*{ki}{}
\makeglossaries
...
\ifdraft{
	...
	%% Adapted from https://tex.stackexchange.com/questions/87610/making-refcheck-work-with-cleveref
	\makeatletter
